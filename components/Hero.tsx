...
export const Hero: React.FC<HeroProps> = ({ movie, onPlay, onAddToPlaylist }) => {
  ...
  if (movie.id === 0) {
    return (
      <div className="relative w-full h-[85vh] overflow-hidden bg-zinc-900">
        ...
        <div className="absolute bottom-0 left-0 pl-16 md:pl-24 pr-8 w-full md:w-2/3 lg:w-1/2 flex flex-col gap-4 z-10 pb-32 md:pb-40">
  ...
  return (
    <div className="relative w-full h-[85vh] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 pl-24 md:pl-32 pr-8 w-full md:w-2/3 lg:w-1/2 flex flex-col gap-4 z-10 pb-32 md:pb-40">
        {/* Tagline Badge */}
        {/* Tagline Badge */}
        ...
        <p className="text-base md:text-lg text-gray-300 font-light leading-relaxed max-w-2xl mb-8 line-clamp-3 drop-shadow-md">
        ...
        <div className="flex items-center gap-4 pt-2">
          ...
          <button
            ...
            className="group w-14 h-14 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/5 backdrop-blur-sm transition-all duration-300 hover:scale-105 active:scale-95"
