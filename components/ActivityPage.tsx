...
export const ActivityPage: React.FC<ActivityPageProps> = ({ onNavigate, initialTab = 'notifications' }) => {
    const {
        followers,
        followingIds,
                        ...
                        <div key={notification.id} className="bg-[#0f1014] border border-white/10 rounded-3xl p-5">
                            <div className="flex items-start justify-between gap-5">
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    <button
                                        onClick={() => void handleRespondToInvite(notification, 'accepted')}
                                    ...
                                    <div key={follower.id} className="p-4 flex items-center justify-between hover:bg-white/5 transition-colors group">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-zinc-500 text-xs uppercase tracking-wider font-semibold mt-1">Started following you</p>
                                            </div>
                                        </div>
