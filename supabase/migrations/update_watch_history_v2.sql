...
-- Created to resolve function signature conflicts/caching issues with v1
-- This ensures a clean slate for the API endpoint
...
BEGIN
  ...
  ELSE
    ...
    IF days_since_last_watch = 0 THEN
      current_streak := current_streak; -- Same day
